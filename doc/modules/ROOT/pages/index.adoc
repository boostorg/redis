...
* For the Boost.Asio API, pass:[C++17] or higher. Supported compilers include gcc 11 and later, clang 11 and later, and Visual Studio 16 (2019) and later.
* For the Corosio API, pass:[C++20] or higher. TODO: supported compilers.
