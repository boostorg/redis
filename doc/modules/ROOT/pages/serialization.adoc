...
* {site-url}/example/cpp20_json.cpp[cpp20_json.cpp] (Asio) /
  {site-url}/example/corosio_json.cpp[corosio_json.cpp] (Corosio):
  serializes and parses JSON objects.
* {site-url}/example/cpp20_protobuf.cpp[cpp20_protobuf.cpp]: serializes and parses https://protobuf.dev/[protobuf] objects (Asio only).
